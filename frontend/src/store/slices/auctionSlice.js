...
export const getAllAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/allitems`,
...
export const getMyAuctionItems = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/myitems`,
      { withCredentials: true }
    );
...
export const getAuctionDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/auction/${id}`,
      { withCredentials: true }
    );
...
export const createAuction = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/create`,
      data,
      {
        withCredentials: true,
...
export const republishAuction = (id, data) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/item/republish/${id}`,
      data,
      {
        withCredentials: true,
...
export const deleteAuction = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_BASE_URL}/auctionitem/delete/${id}`,
      {
        withCredentials: true,
      }
    );
