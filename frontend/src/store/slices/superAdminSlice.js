...
export const getMonthlyRevenue = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/superadmin/monthlyincome`,
...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/superadmin/users/getall`,
      { withCredentials: true }
    );
...
export const getAllPaymentProofs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/superadmin/paymentproofs/getall`,
      { withCredentials: true }
    );
    dispatch(
...
export const deletePaymentProof = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_BASE_URL}/superadmin/paymentproof/delete/${id}`,
      { withCredentials: true }
    );
...
export const getSinglePaymentProofDetail = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `${import.meta.env.VITE_BASE_URL}/superadmin/paymentproof/${id}`,
      { withCredentials: true }
    );
    dispatch(
...
export const updatePaymentProof = (id, status, amount) => async (dispatch) => {
  ...
  try {
    const response = await axios.put(
      `${import.meta.env.VITE_BASE_URL}/superadmin/paymentproof/status/update/${id}`,
      { status, amount },
...
export const deleteAuctionItem = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `${import.meta.env.VITE_BASE_URL}/superadmin/auctionitem/delete/${id}`,
      { withCredentials: true }
    );
